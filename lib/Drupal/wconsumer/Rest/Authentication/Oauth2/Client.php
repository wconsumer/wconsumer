...
use Drupal\wconsumer\Rest\Authentication\Oauth2\Google_OAuth2,
  Drupal\wconsumer\Exception as Oauth2Exception;
/**
 * Tweak off of Google API Client
 */
class Client
{
 /**
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new Oauth2Exception('Cant add services after having authenticated');
    }

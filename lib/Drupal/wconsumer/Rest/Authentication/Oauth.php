...
class Oauth {
  ...
  public $http_info;
 public $useragent = 'wconsumer v.1';
/* Set the useragnet. */
...
class OAuthRequest {
  ...
  public static function from_request($http_method = NULL, $http_url = NULL, $parameters = NULL) {
    ...
    @$http_url or $http_url = $scheme . '://' . $_SERVER['HTTP_HOST'] . ':' . $_SERVER['SERVER_PORT'] . request_uri();
    ...
    if (!$parameters) {
      ...
      } //$http_method == "POST" && @strstr($request_headers["Content-Type"], "application/x-www-form-urlencoded")
  ...
  public function set_parameter($name, $value, $allow_duplicates = TRUE) {
    if ($allow_duplicates && isset($this->parameters[$name])) {
      ...
      } //is_scalar($this->parameters[$name])
  ...
  public static function parse_parameters($input) {
    ...
    foreach ($pairs as $pair) {
      ...
      if (isset($parsed_parameters[$parameter])) {
        ...
        } //is_scalar($parsed_parameters[$parameter])
        $parsed_parameters[$parameter][] = $value;
      } //isset($parsed_parameters[$parameter])
      else {
        $parsed_parameters[$parameter] = $value;
      }
    } //$pairs as $pair
